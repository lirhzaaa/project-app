...
<body>
    <div class="container">
        ...
        <div class="content">
                    ...
                    <a href="../confirm.php" onclick="document.getElementById('input').submit();">
                        <div class="card">
                            <div class="box">
                                ...
                                <p>
                                <p>No Hp: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 1</span></p>
                    ...
                    <a href="../confirm.php" onclick="document.getElementById('input').submit();">
                        <div class="card">
                            <div class="box">
                                <i class="fa-solid fa-mobile"></i>
                                <p>
                                <p>No Hp: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 2</span></p>
                                <p>Status: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Baik</span></p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a href="../confirm.php" onclick="document.getElementById('input').submit();">
                        <div class="card">
                            <div class="box">
                                <i class="fa-solid fa-mobile"></i>
                                <p>
                                <p>No Hp: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 3</span></p>
                                <p>Status: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Baik</span></p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a href="../confirm.php" onclick="document.getElementById('input').submit();">
                        <div class="card">
                            <div class="box">
                                <i class="fa-solid fa-mobile"></i>
                                <p>
                                <p>No Hp: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 4</span></p>
                                <p>Status: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Baik</span></p>
                                </p>
                            </div>
                        </div>
                    ...
                    <a href="../confirm.php" onclick="document.getElementById('input').submit();">
                        <div class="card">
                            <div class="box">
                                <i class="fa-solid fa-mobile"></i>
                                <p>
                                <p>No Hp: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 5</span></p>
                                <p>Status: <span>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp Baik</span></p>
                                </p>
                            </div>
                        </div>
            ...
            <a href="Acer.php"><button class="submit-button" type="submit">Acer</button></a>
            <a href="#!"><button class="submit-button" type="submit">HP</button></a>
            <!-- <div class="content-2">
