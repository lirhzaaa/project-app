    ...
    <div class="side-menu">
        ...
        <ul>
            <?php foreach ($query as $key => $value): ?>
                ...
                <a href="dash.php?page=kontak">
                    <li><i class="fa-solid fa-phone"></i>KONTAK</li>
                </a>
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="cards">
                ...
                if ($barang['jmlhLaptop'] == 0) {
                    echo "Laptop jenis LENOVO Kosong";
                }
                                        ...
                                        <div class="modal-content">
                                            <div class="textModal">
                                                ...
                                                <h6 class="detail">
                                                    ...
                                                    <div class="isi">Tanggal : 10-20-2023 <br></div>
                                                </h6>
                                            </div>
                                            <div class="modalfill">
                                                <p>keperluan:</p>
